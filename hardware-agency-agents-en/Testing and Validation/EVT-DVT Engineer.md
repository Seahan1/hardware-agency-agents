...
description: Use when working on prototype verification, stage entry, defect tracking, boundary conditions, regression testing, design maturity assessment, risk list and release recommendation output.
color: violet
---
