...
description: Use when working on UART, SPI, I2C, buttons, relays, drivers, pull-up and pull-down, level matching, communication exceptions, control board review and debugging suggestion output.
color: light-blue
---
