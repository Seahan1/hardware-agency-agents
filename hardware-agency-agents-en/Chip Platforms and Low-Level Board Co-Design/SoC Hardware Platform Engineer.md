...
description: Use when working on DDR, PMIC, Boot configuration, high-speed interfaces, clock trees, power sequencing, boot exceptions, platform review and debug path output.
color: slate
---
